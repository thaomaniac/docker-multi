...
#    && docker-php-ext-configure gd --with-freetype-dir=/usr/include/ --with-jpeg-dir=/usr/include/ \
	&& docker-php-ext-install -j$(nproc) gd pdo_mysql bcmath intl pdo_mysql soap xsl sockets zip exif

# Install debug
RUN pecl install xdebug
#RUN docker-php-ext-enable xdebug
# Install composer
RUN curl https://getcomposer.org/download/2.7.9/composer.phar --output /usr/bin/composer && chmod +x /usr/bin/composer
# Install N98 CLI for Magento 2
